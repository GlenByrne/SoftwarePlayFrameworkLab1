...
public class HomeController extends Controller {
    ...
    public String saveFile(Long id, FilePart<File> uploaded) {
        ...
        if(uploaded != null) {
            ...
            if(mimeType.startsWith("image/")) {
                ...
                // create at ImageMagik operation - this object is used to specify
                ...
                op.addImage("public/images/productImages/largeImages/" + id + ".jpg");
                // create another Image Magick oeration and repeat the process above to
                ...
                // now we create an Image Magick comman and execute the operations
    ...
    public Result productDetails(Long id) {
        ...
        return ok(productDetails.render(id, productList, User.getUserById(session().get("email")), e));
    }
}
